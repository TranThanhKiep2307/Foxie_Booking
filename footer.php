            ...
            <div class="col-md-6 col-lg-4">
                <div class="bg-primary rounded p-4">
                    ...
                    <p class="text-white mb-0">
                        <a class="text-dark fw-medium" href="https://htmlcodex.com/hotel-html-template-pro">FOXIE – FLY
                        </a>Tiến hành đặt vé ngay để có những trải nghiệm tuyệt vời cùng chúng tôi. FOXIE - FLY hân hạnh
                ...
                <div class="col-lg-10 border rounded p-1">
                    <div class="border rounded text-center p-1">
                        <div class="bg-white rounded text-center p-5">
                            <h4 class="mb-4">Đăng kí để biết thêm <span class="text-primary text-uppercase">THÔNG TIN</span></h4>
...
>>>>>>> 997b956a9276323eb814658d433c6218167afdd3
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <h6 class="section-title text-start text-primary text-uppercase mb-4">Liên hệ </h6>
