...
<head>
    ...
    <link rel="shortcut icon" href="/img/foxie.png" type="image/x-icon">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="booking.php" class="nav-item nav-link">Đặt vé</a>
                                ...
                                <a href="index.php" class="nav-item nav-link">Trang chủ</a>
                                <a href="service.php" class="nav-item nav-link ">Dịch vụ</a>
                                <a href="booking.php" class="nav-item nav-link active">Đặt vé</a>
                                <a href="contact.php" class="nav-item nav-link">Liên Hệ</a>
                                      <?php break;
                                    case 'contact': ?>
                                <a href="index.php" class="nav-item nav-link">Trang chủ</a>
