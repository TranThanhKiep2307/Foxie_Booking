            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">Foixe Fly</span></h1>
                        <p class="mb-4">Hệ thống săn vé máy bay giá rẻ Vietjet, Vietnam Airlines, Bamboo, Pacific, Vietravel. Tìm và đặt vé máy bay online, so sánh giá vé từ hơn 200 hãng hàng không quốc tế và nội địa. Hình thức thanh toán linh hoạt qua internet banking, Visa, Master...</p>
                        <div class="row g-3 pb-4">
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.1s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <i class="fa fa-plane-departure fa-2x text-primary mb-2"></i>
                                        <h2 class="mb-1" data-toggle="counter-up">1000</h2>
                                        <p class="mb-0">Chuyến bay</p>
                                    </div>
                                </div>
                            </div>
